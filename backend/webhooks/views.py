...
# from finances.models import Categorias_Pagamentos, Caixas_Frasson
...
#     elif id == 302757413:
#         Card_Pagamentos.objects.filter(pk=id_card).update(**{'phase_id': new_phase_id, 'phase_name': new_phase_name})
#     elif id == 302821542:
#         Card_Cobrancas.objects.filter(pk=id_card).update(**{'phase_id': new_phase_id, 'phase_name': new_phase_name})
#     return JsonResponse({'message': 'Webhook status ok'})
...
#         elif id == 302757413:
#             card = Card_Pagamentos.objects.get(pk=id_card).delete()
#         elif id == 302821542:
#             card = Card_Cobrancas.objects.get(pk=id_card).delete()
