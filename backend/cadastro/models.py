...
class Instituicoes_Razao_Social(models.Model): 
    ...
    abreviatura = models.CharField(max_length=100, null=True, blank=True, verbose_name='Abreviatura')
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    class Meta:
...
class Instituicoes_Parceiras(models.Model): 
    ...
    numero_agencia = models.CharField(max_length=30, null=True, blank=True, default=None, verbose_name='Número Agência')
    cep_logradouro = models.CharField(max_length=30, null=True, blank=True, verbose_name='CEP Logradouro')
...
class Cadastro_Pessoal(models.Model): 
    ...
    numero_rg = models.CharField(max_length=50, null=True, blank=True, verbose_name='Número RG')
    cep_logradouro = models.CharField(max_length=30, null=True, blank=True, verbose_name='CEP Logradouro')
    logradouro = models.CharField(max_length=255, null=True, blank=True, verbose_name='Logradouro')
    municipio = models.ForeignKey(Municipios, null=True, on_delete=models.SET_NULL, verbose_name='Município')
    data_nascimento = models.DateField(null=True, blank=True, verbose_name='Data Nascimento')
    contato1 = models.CharField(max_length=100, null=True, blank=True, verbose_name='Contato 01')
    contato2 = models.CharField(max_length=100, null=True, blank=True, verbose_name='Contato 02')
    email1 = models.CharField(max_length=100, null=True, blank=True, verbose_name='Email 01')
    email2 = models.CharField(max_length=100, null=True, blank=True, verbose_name='Email 02')
    grupo = models.ForeignKey(Grupos_Clientes, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Grupo')
    # profissao = models.CharField(max_length=255, null=True, verbose_name='Profissão')
    avatar = models.FileField(null=True, blank=True, default='avatars/clients/default-avatar.jpg', upload_to='avatars/clients')
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Criado Por')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    class Meta:
