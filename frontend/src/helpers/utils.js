...
export const convertGMStoGD = (graus, minutos, segundos) =>{
  if (graus <= 0) {
      return
  }
  ...
  var minutos_convert = Number(minutos) / 60
  var segundos_convert = Number(segundos) / 3600
  var valor_gd = (Number(graus) + minutos_convert + segundos_convert)
  var valor_final = valor_gd.toFixed(6) * -1
  return valor_final
}

export const convertGDtoGMS = (val, type) => {
