...
const NavGai = ({card}) =>{
    ...
    <Nav variant="pills" className="flex-row fs--2">
        ...
        <Nav.Item>
            <Nav.Link className="text-secondary px-1 py-0 border-1 border me-2 custom-tab link-primary" eventKey="pvtec">
                <FontAwesomeIcon icon={faFilter} className="me-1"/>PVTEC
            </Nav.Link>
        </Nav.Item>
        <Nav.Item>
            <Nav.Link className="text-secondary px-1 py-0 border-1 border me-2 custom-tab mb-2 link-primary" eventKey="prospects">
