...
export const fieldsPessoal = [
  {name:'categoria', label:'Categoria*', type:'select', string:'str_categoria'},
  ...
  {name:'cep_logradouro', label:'CEP*', type:'text'}, 
...
export const fieldsAnaliseSolo = [
  ...
  {name:'profundidade', label:'Profundidade (cm)*', type:'text', is_number:true},
  ...
  {name:'ph_h2O', label_html:<>pH H<sub>2</sub>O</>, type:'text', tooltip:'Informe aqui o pH em Água.'},
  {name:'ph_cacl2', label_html:<>pH CaCl<sub>2</sub></>, type:'text', tooltip:'Informe aqui o pH em CaCl.'},
  {name:'argila_percentual', label:'Argila (%)', type:'text'},
  {name:'silte_percentual', label:'Silte (%)', type:'text'},
  {name:'areia_percentual', label:'Areia (%)', type:'text'},
]
