...
import { dashboardRoutes } from "../siteMaps";
...
const Dashboard = () =>{
    ...
    return (
        <>
        <CustomBreadcrumb>
          <span className="breadcrumb-item fw-bold" aria-current="page">Dashboards</span>    
        </CustomBreadcrumb>
        <Row className="g-3">
          {dashboardRoutes.children.map(c => <div key={c.name}>
