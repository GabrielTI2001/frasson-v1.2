...
import { ambientalRoutes } from "../siteMaps";
...
const Ambiental = () =>{
    ...
    return (
      <>
        <CustomBreadcrumb>
          <span className="breadcrumb-item fw-bold" aria-current="page">Gestão Ambiental e Irrigação</span>    
        </CustomBreadcrumb>
        <Row className="g-3">
          {ambientalRoutes.children.map(c => <div key={c.name}>
