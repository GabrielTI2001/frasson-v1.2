...
import { operacionalRoutes } from "../siteMaps";
...
const Operacional = () =>{
    ...
    return (
        <>
        <CustomBreadcrumb>
          <span className="breadcrumb-item fw-bold" aria-current="page">Operacional</span>    
        </CustomBreadcrumb>
        <Row className="g-3">
          {operacionalRoutes.children.map(c => <div key={c.name}>
