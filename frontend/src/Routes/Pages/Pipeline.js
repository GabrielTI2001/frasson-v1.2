...
import { pipelineRoutes } from "../siteMaps";
...
const Pipeline = () =>{
    ...
    return (
        <>
        <CustomBreadcrumb>
          <span className="breadcrumb-item fw-bold" aria-current="page">Pipeline</span>    
        </CustomBreadcrumb>
        <Row className="g-3">
          <div>
            <h4 className="mb-1 fw-bold fs--1">Fluxos</h4>
            <Row className="gx-4 gy-0">
              {pipelineRoutes.children.map(i => 
